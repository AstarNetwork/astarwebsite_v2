    ...
    <div class="max-w-7xl mx-auto px-4 sm:flex">
      <div class="sm:py-24 sm:mr-16 sm:w-1/2 mb-8 sm:mb-0">
        ...
        <IncubationButton
          variant="outlined"
          color="secondary"
          :href="localePath('/incubation/program')"
        >
          <span>
            {{ $t("incubation.program.timeline.learn_more") }}
        ...
        <ol class="timeline space-y-12">
          <li class="after:bg-space-pink before:text-space-pink">
            <h3 class="text-space-pink">
              ...
              <small>
                ({{ $t("incubation.program.timeline.application.duration") }})
              </small>
            </h3>
            <p class="text-gray-300">
              {{
                $t("incubation.program.timeline.application.description_short")
              }}
            </p>
          </li>
          <li class="after:bg-space-sky before:text-space-sky">
            ...
            <p class="text-gray-300">
              {{
                $t("incubation.program.timeline.incubation.description_short")
              }}
            </p>
          </li>
          <li class="after:bg-space-cyan before:text-space-cyan">
            <h3 class="text-space-cyan">
              {{ $t("incubation.program.timeline.demo.title") }}
            </h3>
            <p class="text-gray-300">
              {{ $t("incubation.program.timeline.demo.description_short") }}
            </p>
          </li>
        </ol>
      </div>
